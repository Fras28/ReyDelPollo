    ...
    >
      <div className="landingStart">
        ...
        <div className="BottomLanding">
          <div>
            <img src={Logo} alt="" className="logoStart" />
            <AlertDialogSlide />
          </div>
          ...
          <div className="btnEnter" onClick={handleButtonClick}>
            ...
            <a
              ...
              className="ubi"
              href="https://www.google.com/maps/place/Zapiola+69,+B8000CLA+Bah%C3%ADa+Blanca,+Provincia+de+Buenos+Aires/@-38.7136159,-62.2620106,17z/data=!3m1!4b1!4m6!3m5!1s0x95eda3532f3fcf3d:0xc3ed006645e95e9c!8m2!3d-38.7136159!4d-62.2620106!16s%2Fg%2F11f6kymq4s?entry=ttu"
              target="_blank"
            >
              {Location}Zapiola 69
            </a>
